	...
	public function pwapp_extended_purifier( $config ) {
		...
		if ( class_exists( 'HTMLPurifier' ) ) {
			...
			if ( $def ) {
				...
				$def->addElement(
					'video', 'Block', 'Optional: (source, Flow) | (Flow, source) | Flow', 'Common', array(
						'src'      => 'URI',
						'type'     => 'Text',
						'width'    => 'Length',
						'height'   => 'Length',
				...
				$def->addElement(
					'audio', 'Block', 'Optional: (source, Flow) | (Flow, source) | Flow', 'Common', array(
						'src'      => 'URI',
						'type'     => 'Text',
						'width'    => 'Length',
						'height'   => 'Length',
				...
				$def->addElement(
					'ins', 'Block', 'Flow', 'Common', array(
						'cite'     => 'URI',
						'datetime' => 'CDATA',
					)
				);
				$def->addElement(
					'del', 'Block', 'Flow', 'Common', array(
						'cite'     => 'URI',
						'datetime' => 'CDATA',
					)
				);
				...
				$info['min-width'] = $info['min-height'] = new \HTMLPurifier_AttrDef_CSS_Composite(
					array(
